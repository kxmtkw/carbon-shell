...
class MaterialColors:
    ...
    def __init__(self):
        ...
        self.darkMapping: list[tuple[str, str]]
        self.lightMapping: list[tuple[str, str]]
    ...
    def generate(self):
        ...
        theme = material.theme_from_color("#47AA12", 0.01, material.Variant.CONTENT)
    ...
    def make_mapping(self, s: material.DynamicScheme) -> list[tuple[str, str]]:
        scheme = [
...
def updateQuickshell(s: list[tuple[str, str]]) -> str:
    base = """
    pragma Singleton
...
def updateColors(colors: MaterialColors):
    ...
    for type, filepath in color_files.items():
        ...
        match type:
            case "qml":
                string = updateQuickshell(colors.darkMapping)
            case "kitty":
                string = ""
                return
            case "rofi":
