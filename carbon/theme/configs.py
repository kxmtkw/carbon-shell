...
def update_alacritty(s: dict[str, str]) -> str:
    return f"""
...
def update_kitty(s: dict[str, str]) -> str:
    return (
        "// NOTE: written by carbon shell\n"
...
def update_hypr(s: dict[str, str]) -> str:
    ...
    return (
        ...
        f"$surfaceContainer = rgb({s['surfaceContainer'][1:]})\n"
        f"$primary = rgb({s['primary'][1:]})\n"
        f"$onPrimary = rgb({s['onPrimary'][1:]})\n"
        f"$primaryContainer = rgb({s['primaryContainer'][1:]})\n"
        f"$secondary = rgb({s['secondary'][1:]})\n"
        f"$onSecondary = rgb({s['onSecondary'][1:]})\n"
        f"$secondaryContainer = rgb({s['secondaryContainer'][1:]})\n"
        f"$tertiary = rgb({s['tertiary'][1:]})\n"
        f"$onTertiary = rgb({s['onTertiary'][1:]})\n"
        f"$tertiaryContainer = rgb({s['tertiaryContainer'][1:]})\n"
